...
export function answer(raw: string): FangAnswer {
  ...
  if (has(q, "สุ่ม", "กาชา", "gacha", "lucky", "เมนูลับ")) {
    return {
      text: 'ตู้กาชา "สุ่มแก้วกับฟ่าง" อยู่ที่หน้า "สุ่มแก้วกับฟ่าง" (กดจากหน้าแรกหรือเมนูบนได้เลย) 🎰 ข้างในมีทั้งเมนูหลักบางส่วน + เมนูลับ/เมนูทดลองที่ไม่มีในเมนูหลัก กดหมุนแล้วลุ้นได้เลย ถ้าถูกใจกด "เอาแก้วนี้!" ก็ลงตะกร้าได้ทันที 💜',
      confident: true,
    };
  }
